					...
					<div class="row">
						...
						<div class="col-lg-9 custom-col-9">
							...
							<div class="form-group pmd-textfield">
										<label class="control-label col-sm-3" for="u_password">Recent Password</label>
										<div class="col-sm-9">
											<input type="password" class="form-control empty" name="pass" value="" required="">
										</div>
									</div>
									<div class="form-group pmd-textfield">
										<label class="control-label col-sm-3" for="u_password">New Password</label>
										<div class="col-sm-9">
											<input type="password" class="form-control empty" name="newpass" id="newpass" value="" required="">
										</div>
									</div>
									<div class="form-group pmd-textfield">
										<label class="control-label col-sm-3" for="u_password">Re-Type Password</label>
										<div class="col-sm-9">
											<input type="password" class="form-control empty" name="retype" id="retype" value="" onchange="checkPasswordMatch()" required>
...
<br>
									<div class="form-group btns margin-bot-30">
										  <div class="col-sm-9 col-sm-offset-3">
											<input type="submit" value="Save" name="edit_pass" class="btn btn-primary pmd-ripple-effect">
