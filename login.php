...
<?php
//php script
include_once("function/controller_login.php");
   	...
   	<div class="pmd-card card-default pmd-z-depth">
 		<div class="login-card">
 			<form method="post">
 				<div class="pmd-card-title card-header-border text-center">
 					...
 					<h3>Sign In <span>to <strong>Bandung Digital Valley</strong></span></h3>
 				</div>
 				...
 				<div class="pmd-card-body">
                     ...
                     <div class="form-group pmd-textfield pmd-textfield-floating-label">
                         ...
                         <div class="input-group">
                             ...
                             <input type="email" name="emailLogin" class="form-control" id="exampleInputAmount" value="<?php if(isset($_COOKIE["member_login"])) { echo $_COOKIE["member_login"]; } ?>">
                         </div>
                     </div>
                     ...
                     <div class="form-group pmd-textfield pmd-textfield-floating-label">
                         ...
                         <div class="input-group">
                             ...
                             <input type="password" name="passLogin" class="form-control" id="exampleInputAmount" value="<?php if(isset($_COOKIE["member_password"])) { echo $_COOKIE["member_password"]; } ?>">
                         </div>
                     </div>
                 </div>
          ...
          <!-- <a href="index.html" type="button" class="btn pmd-ripple-effect btn-primary btn-block">Login</a> -->
 					...
 					<p class="redirection-link">Don't have an account? <a href="register.php" class="login-register">Sign Up</a>. </p>
 		...
 		<div class="forgot-password-card">
 			<form>
 			  ...
 			  <div class="pmd-card-footer card-footer-no-border card-footer-p16 text-center">
          <button type="submit" name="submitForgot" class="btn pmd-ripple-effect btn-primary btn-block">Submit</button>
 			  	<!-- <a name="submit" type="button" class="btn pmd-ripple-effect btn-primary btn-block">Submit</a> -->
