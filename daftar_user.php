...
include_once("function/controller_register_adm.php");
session_start();
$role_session = $_SESSION['role'];
if($_SESSION['role']!="superuser"){
	?>
<script>document.location='Admin/index.php';</script>
<?php } ?>
...
<aside class="pmd-sidebar sidebar-default pmd-sidebar-slide-push pmd-sidebar-left pmd-sidebar-open bg-fill-darkblue sidebar-with-icons" role="navigation">
	<ul class="nav pmd-sidebar-nav">
		...
		<li>
			<a class="pmd-ripple-effect" href="Admin/index.php">
...
<g>
	<path fill="#C9C8C8" d="M307.555,407.535h-9.108v10.264h9.108V407.535z M287.725,407.535v6.232h9.109v-6.232H287.725z
		...
		<li>
      <a class="pmd-ripple-effect" href="Admin/data-member.php">
...
<path fill="#C9C8C8" d="M0,0v12.706h18V0H0z M12.706,4.235v3.176H9.108V4.235H12.706z M8.049,4.235v3.176h-6.99V4.235H8.049z
	...
	h-3.176V4.235h3.176V7.412L16.942,7.412z"/>
		...
		<li>
			<a class="pmd-ripple-effect" href="Admin/data-memberlama.php">
				<i class="media-left media-middle"><svg version="1.1" x="0px" y="0px" width="18px" height="12.706px" viewBox="0 0 18 12.706" enable-background="new 0 0 18 12.706" xml:space="preserve">
<path fill="#C9C8C8" d="M0,0v12.706h18V0H0z M12.706,4.235v3.176H9.108V4.235H12.706z M8.049,4.235v3.176h-6.99V4.235H8.049z
	 M1.059,8.47h6.99v3.177h-6.99V8.47z M9.108,11.647V8.47h3.599v3.177H9.108z M13.766,11.647V8.47h3.176v3.177H13.766z M16.942,7.412
	h-3.176V4.235h3.176V7.412L16.942,7.412z"/>
		...
		<li>
			<a class="pmd-ripple-effect" href="Admin/data-absensi.php">
				<i class="media-left media-middle"><svg version="1.1" x="0px" y="0px" width="18px" height="12.706px" viewBox="0 0 18 12.706" enable-background="new 0 0 18 12.706" xml:space="preserve">
<path fill="#C9C8C8" d="M0,0v12.706h18V0H0z M12.706,4.235v3.176H9.108V4.235H12.706z M8.049,4.235v3.176h-6.99V4.235H8.049z
	 M1.059,8.47h6.99v3.177h-6.99V8.47z M9.108,11.647V8.47h3.599v3.177H9.108z M13.766,11.647V8.47h3.176v3.177H13.766z M16.942,7.412
	h-3.176V4.235h3.176V7.412L16.942,7.412z"/>
		...
		<li>
			<a class="pmd-ripple-effect" href="Admin/data-privilege.php">
				<i class="media-left media-middle"><svg version="1.1" x="0px" y="0px" width="18px" height="12.706px" viewBox="0 0 18 12.706" enable-background="new 0 0 18 12.706" xml:space="preserve">
<path fill="#C9C8C8" d="M0,0v12.706h18V0H0z M12.706,4.235v3.176H9.108V4.235H12.706z M8.049,4.235v3.176h-6.99V4.235H8.049z
	 M1.059,8.47h6.99v3.177h-6.99V8.47z M9.108,11.647V8.47h3.599v3.177H9.108z M13.766,11.647V8.47h3.176v3.177H13.766z M16.942,7.412
	h-3.176V4.235h3.176V7.412L16.942,7.412z"/>
...
<div id="content" class="pmd-content inner-page">
	...
	<div class="container-fluid full-width-container about">
		...
		<ol class="breadcrumb text-left">
		  <li><a href="Admin/data-member.php">Data Member</a></li>
		  <li class="active">BDV Management Member</li>
		</ol><!--breadcrum end-->
		...
		<div class="page-content profile-edit dashboard">
			<div class="pmd-card pmd-z-depth">
				<div class="pmd-card-body">
					<div class="row">
			<form class="form-horizontal" method="POST" action="daftar_user.php" enctype="multipart/form-data">
						...
						<div class="col-lg-5 custom-col-5">
							...
							<div class="row">
										...
										<div class="form-group prousername pmd-textfield">
										  ...
										  <div class="col-sm-9">
											<input type="text" name="username" class="form-control empty" id="username" placeholder="ketik username">
										  </div>
										</div>
                                  ...
                                  <div class="form-group prousername pmd-textfield">
										  ...
										  <div class="col-sm-9">
											<input type="email" name="email" class="form-control empty" id="email" placeholder="ketik email">
										  </div>
										</div>
                    ...
                    <div class="form-group prousername pmd-textfield">
										  <label class="control-label col-sm-3">Role Privilege</label>
										  <div class="col-sm-9">
											<select class="select-simple form-control pmd-select2" style="width: 100%;" name="role" id="role" required>
					                        <option value="superuser">Super User</option>
											 <option value="standaruser">Standar User</option>
											 <option value="basicuser" selected="selected">Basic User</option>
					...
					<div class="row">
							...
							<button type="submit" name="submit" class="btn btn-primary pmd-ripple-effect">Add User</button>
							<a href="Admin/data-privilege.php" class="btn btn-default btn-link pmd-ripple-effect">Back</a>
							</div>
						</div>
          	</form>
					</div>
...
<!--circle chart-->
<script src="Admin/themes/js/circles.min.js"></script>
<script>
...
<script src="Admin/themes/js/highcharts.js"></script>
<script src="Admin/themes/js/highcharts-more.js"></script>
