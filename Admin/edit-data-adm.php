...
<?php
$email = $_GET['email'];
$query = mysql_query("SELECT * FROM tb_adm WHERE email='$email' ");
		...
		<div class="page-content profile-edit dashboard">
			<div class="pmd-card pmd-z-depth">
				<div class="pmd-card-body">
					<div class="row">
			<form class="form-horizontal" method="POST" action="admin_update_privilege.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group prousername pmd-textfield">
										  ...
										  <div class="col-sm-9">
											<select class="select-simple form-control pmd-select2" style="width: 100%;" name="role" id="" required>
											...
											<?php }
											else if($role_session=="standaruser"){
												?>
													<option value="<?php echo $role ;?>"><?php echo ucwords($role);?></option>
                    ...
                    <div class="form-group prousername pmd-textfield">
										  ...
										  <div class="col-sm-9">
											<input type="text" name="email" class="form-control empty" id="email" placeholder="" value="<?php echo $email;?>">
										  </div>
										</div>
					...
					<div class="row">
							...
							<a href="delete-privilege.php?id=<?php echo $id;?>" class="btn btn-danger pmd-ripple-effect" onclick="return confirm('Yakin delete user ini?')">Delete User</a>
							<a href="data-privilege.php" class="btn btn-default btn-link pmd-ripple-effect">Back</a>
							</div>
						</div>
          	</form>
					</div>
