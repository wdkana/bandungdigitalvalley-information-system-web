				...
				<?php
					...
					<tr>
						...
						<td>
							<?php if($jam_keluar==""){
								?>
								<a href="?member_id=<?php echo $id;?>&tgl=<?php echo $tgl?>" class="pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">Absen Keluar</a>
								<?php 
							}else{?>
							<?php echo $jam_keluar; } ?>
