...
<div id="content" class="pmd-content content-area dashboard">
			<table id="example" class="display" cellspacing="0" width="100%">
				...
				<?php
				$query = mysql_query("SELECT * FROM tb_oldmember");
				...
				?>
					<tr>		
						...
						<td><?php echo ucwords($tgl_lahir);?></td>
                    ...
                    <td class="pmd-table-row-action">
							<a href="edit-data_member_lama.php?email=<?php echo $email;?>" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
								<i class="material-icons md-dark pmd-sm">edit</i>
							</a>
							<a href="lihat-data_member_lama.php?email=<?php echo $email;?>" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
		...
		<div>
			<div class="pull-right table-title-top-action" style="margin:0 auto">
				<a href="export_data_member_lama.php?memberlama" class="btn btn-primary pmd-btn-raised add-btn pmd-ripple-effect pull-left">Export Data Member Lama</a>
			</div>
		</div>
</div>
<!--tab start-->
