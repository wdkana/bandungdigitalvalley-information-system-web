...
<div id="content" class="pmd-content inner-page">
	...
	<div class="container-fluid full-width-container about">
		...
		<h1 class="section-title" id="services">
			<span>Lihat Detail Member Lama</span>
		</h1><!-- End Title -->

		<!--breadcrum start-->
		<ol class="breadcrumb text-left">
		  <li><a href="data-member.php">Data Member Lama</a></li>
		  <li class="active">Lihat Detail Member Lama</li>
		</ol><!--breadcrum end-->
				...
				<div class="pmd-card-body">
								...
								<form class="form-horizontal">
								  <fieldset>
										...
										<div class="form-group prousername pmd-textfield">
										  ...
										  <div class="col-sm-9">
											<p class="form-control-static"><strong><?php echo $alamat;?></strong></p>
										  </div>
										</div>
										<div class="form-group prousername pmd-textfield">
                    ...
                    <div class="form-group prousername pmd-textfield">
										...
										<div class="form-group prousername pmd-textfield">
										  ...
										  <div class="col-sm-9">
											<p class="form-control-static"><strong><?php echo $website;?></strong></p>
										  </div>
										</div>
										<div class="form-group prousername pmd-textfield">
										  <label class="control-label col-sm-3">KTP</label>
										  <div class="col-sm-9">
											<p class="form-control-static"><strong><?php echo $ktp;?></strong></p>
										  </div>
										</div>
					...
					<div class="row">
							...
							<a href="edit-data_member_lama.php?email=<?php echo $email;?>">
