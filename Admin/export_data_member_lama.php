...
if(isset($_GET['absensi'])){
	$qry = "SELECT a.nama, a.email, a.profesi, c.tgl_akses FROM tb_oldmember a, tb_mac_address b, tb_logs c WHERE a.id_user = b.id_user AND b.mac_address = c.mac_address";	
}elseif (isset($_GET['memberlama'])) {
	$qry = "SELECT * FROM tb_oldmember";	
}
	...
	<div class="row" style="height:300px;overflow:scroll;">
	    <table id="data" class="table table-striped">
	        <thead>
		        ...
		        ?>
		        <tr class="warning">
			        <th colspan="4"> Data Member Lama</th>
			    </tr>
			    <tr class="warning">
	                <th>Nama</th>
						<th>Profesi</th>
...
function getFileName(settings) {
    return ( settings.filename ? settings.filename : "datamemberlama") + ".xls";
}
