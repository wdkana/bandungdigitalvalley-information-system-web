...
<?php
$email = $_GET['email'];
$query = mysql_query("SELECT * FROM tb_oldmember WHERE email='$email' ");
...
<div id="content" class="pmd-content inner-page">
	...
	<div class="container-fluid full-width-container about">
		...
		<h1 class="section-title" id="services">
			<span>Edit Data Member Lama</span>
		</h1><!-- End Title -->

		<!--breadcrum start-->
		<ol class="breadcrumb text-left">
		  <li><a href="data-member.php">Data Member Lama</a></li>
		  <li class="active">Edit Data Member Lama</li>
		</ol><!--breadcrum end-->
		...
		<div class="page-content profile-edit dashboard">
			...
			<form class="form-horizontal" method="POST" action="admin_update_userP.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group prousername pmd-textfield">
										  ...
										  <div class="col-sm-9">
											<input type="text" name="alamat" class="form-control empty" id="alamat" placeholder="" value="<?php echo $alamat;?>">
										  </div>
										</div>
                    <div class="form-group prousername pmd-textfield">
                    ...
                    <div class="form-group prousername pmd-textfield">
					 ...
					 <div class="form-group prousername pmd-textfield">
										  ...
										  <div class="col-sm-9">
											<input type="text" name="website" class="form-control empty" id="website" placeholder="" value="<?php echo $website;?>">
										  </div>
										</div>
					 ...
					 <div class="form-group prousername pmd-textfield">
										  ...
										  <div class="col-sm-9">
											<input type="text" name="ktp" class="form-control empty" id="ktp" placeholder="" value="<?php echo $ktp;?>">
										  </div>
										</div>						
										<div class="form-group prousername pmd-textfield">
					...
					<div class="row">
							...
							<a href="delete-member-lama.php?permission=true&mailid=<?php echo $email?>" class="btn btn-danger btn-link pmd-ripple-effect" onclick="return confirm('Yakin delete user ini?')">Delete</a>
							<a href="data-memberlama.php" class="btn btn-default btn-link pmd-ripple-effect">Back</a>
							</div>
						</div>
          	</form>
					</div>
