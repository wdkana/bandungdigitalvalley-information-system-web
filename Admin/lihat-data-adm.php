...
<div id="content" class="pmd-content inner-page">
	...
	<div class="container-fluid full-width-container about">
		...
		<h1 class="section-title" id="services">
			<span>Lihat Detail User Manajemen</span>
		</h1><!-- End Title -->

		<!--breadcrum start-->
		<ol class="breadcrumb text-left">
		  <li><a href="data-member.php">Data Role User</a></li>
		  <li class="active">Lihat Data User Manajemen</li>
		</ol><!--breadcrum end-->
			...
			<div class="pmd-card pmd-z-depth">
				<div class="pmd-card-body">
							...
							<div class="row">
								<form class="form-horizontal">
								  <fieldset>
										...
										<div class="form-group prousername pmd-textfield">
										  <label class="control-label col-sm-3">Privilege Role</label>
										  <div class="col-sm-9">
											<p class="form-control-static"><strong><?php echo ucwords($role);?></strong></p>
										  </div>
										</div>
										<div class="form-group prousername pmd-textfield">
					...
					<div class="row">
							...
							<a href="edit-data-adm.php?email=<?php echo $email;?>">
